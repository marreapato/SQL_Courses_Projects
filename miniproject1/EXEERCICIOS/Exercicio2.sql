...
order by 1; NOT THE SAME ONE AS I'VE DONE*/

SELECT COUNT(*),DEPARTAMENTO FROM FUNCIONARIOS WHERE DEPARTAMENTO='Filmes' OR DEPARTAMENTO='Roupas' GROUP BY DEPARTAMENTO;^X
-- 21 | Filmes   53 | Roupas
